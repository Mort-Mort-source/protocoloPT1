...
A continuación se presenta la Tabla \ref{tab:comparativa}, que compara las soluciones analizadas según criterios relevantes para el proyecto: apertura de canales, modelo de notificaciones, arquitectura subyacente, usabilidad reportada y capacidad de integración institucional.
