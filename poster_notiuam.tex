...
\begin{frame}[t]
    ...
    \end{block}
        ...
        \begin{block}{\Large 3. Características y Objetivos}
            \textbf{NotiUam} es una plataforma distribuida basada en el modelo \textit{publisher-subscriber} que permite:
            \begin{itemize}[leftmargin=*, itemsep=1pt]
                ...
                \item Autenticar de manera segura.
            \end{itemize}
            \textbf{Objetivos:}
