...
\begin{figure}[H]
\centering
\includegraphics[width=0.23\textwidth]{imagenes/metodologia_flujo.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{imagenes/arquitectura_componentes.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.65\textwidth]{imagenes/secuencia_publicacion.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{imagenes/actividades_usabilidad.png}
