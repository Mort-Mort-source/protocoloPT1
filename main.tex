...
\email{aaron.r.ramos@cuam.uam.mx}
...
\begin{titlepage}
    ...
    % Logo UAM
    \includegraphics[width=0.28\textwidth]{imagenes/logo_uam.png}
    \vskip 1.5cm
    ...
    {\LARGE\bfseries Plataforma distribuida de comunicación y alertas comunitarias\\ para entornos universitarios (Noti Uam) \par}
    \vskip 2cm
    ...
    \begin{tabular}{rl}
        ...
        \textbf{Asesor:}   & Dr. Guillermo Monroy Rodriguez \\      % <--- CAMBIAR POR EL NOMBRE REAL
        \textbf{Universidad:} & UAM Cuajimalpa \\
    \end{tabular}
...
(Foross, redes sociales, correo institucional), lo que provoca baja visibilidad de eventos académicos, 
...
una plataforma distribuida de comunicación y alertas comunitarias orientada a entornos universitarios.
 El sistema se basa en una arquitectura distribuida \textit{publish-subscribe} (pub-sub) que permite la creación de 
