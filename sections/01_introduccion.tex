...
Ante este panorama, se propone el desarrollo de \textbf{Noti Uam}, una plataforma distribuida de comunicación y alertas comunitarias específicamente orientada a entornos universitarios. La plataforma se basa en una arquitectura \textit{publish-subscriber} (pub-sub) que permite:
