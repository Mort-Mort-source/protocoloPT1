...
\begin{itemize}
    ...
    \item \textbf{Herramientas}: PlantUML, Swagger Editor, pgModeler.
...
\begin{itemize}
    ...
    \item \textbf{Herramientas}: Docker, Docker Compose, Git.
...
\begin{itemize}
    ...
    \item \textbf{Herramientas}: IntelliJ IDEA, Maven, Spring Boot 3.x, Kafka Client.
...
\begin{itemize}
    ...
    \item \textbf{Criterios de aceptación}: Las consultas de listado de canales deben ejecutarse en menos de 200 ms con caché habilitada.
    \item \textbf{Duración}: 3 semanas.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Actividades}:
        ...
        \end{enumerate}
    \item \textbf{Entregables}: Reporte de pruebas de integración, log de errores corregidos.
    \item \textbf{Herramientas}: Postman, Newman (línea de comandos), Docker Compose.
    \item \textbf{Criterios de aceptación}: El 100\% de los casos de prueba definidos en la fase 1 deben pasar.
    \item \textbf{Duración}: 3 semanas.
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{Actividades}:
        \begin{enumerate}
            \item Realizar pruebas de carga con JMeter: simular 500, 1000 y 1500 usuarios concurrentes publicando y recibiendo notificaciones.
...
\begin{itemize}
    \item \textbf{Objetivo}: Consolidar todos los resultados y preparar los materiales para la defensa del proyecto terminal.
    \item \textbf{Actividades}:
        \begin{enumerate}
            \item Redactar el informe final (estructura de tesis).
            \item Elaborar manual de instalación y guía de usuario.
            \item Preparar presentación en diapositivas (PowerPoint / LaTeX Beamer).
            \item Ensayar la defensa con el asesor.
        \end{enumerate}
    \item \textbf{Entregables}: Tesis completa (PDF), código fuente en repositorio, manuales, presentación.
    \item \textbf{Herramientas}: Overleaf / LaTeX, GitHub, Canva / PowerPoint.
    \item \textbf{Criterios de aceptación}: Aprobación del asesor y del jurado.
    \item \textbf{Duración}: 4 semanas (se solapa con las semanas finales del trimestre).
\end{itemize}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.30\textwidth]{imagenes/metodologia_flujo.png}
...
\begin{enumerate}
    ...
    \item Las pruebas de carga indican que la latencia media es inferior a 2 segundos para 1000 eventos por segundo.
    \item La puntuación SUS media es superior a 70.
    \item La documentación final (tesis) ha sido aprobada por el asesor y el jurado.
\end{enumerate}
