...
Cada objetivo específico se fundamenta en los conceptos expuestos en el marco teórico. La Tabla \ref{tab:objetivos_marco} muestra dicha correspondencia.
...
\begin{comment}
Se comenta a peticion del codirector.
